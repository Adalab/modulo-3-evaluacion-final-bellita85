...
return ( <div className="div-detail">
        
<Link to="/" className="nav" ><p className="nav">Volver</p></Link> 
...
<form className="form-detail" onSubmit={props.handleOnSubmit}>  
        <label> Si quieres puedes compartir esta URL con tu vecina </label>
        <input
...
if (charactersFound !== undefined) {return paintCharacter() } else {return (<div><Error text="ERROR "  text2="El servidor no contesta o la pagina buscada no existe" text3="Volver a la pagina inicial"></Error></div>)} 
